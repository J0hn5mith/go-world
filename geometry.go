...
//func (triangle *Triangle) vertices() []mgl32.Vec3 {
//return  new([]mgl32.Vec3, {triangle.v1, triangle.v2, triangle.v3})
//}

//func (triangle *Triangle) as_array() []float32 {
//var vertices []float32
//for _, vertice := range triangle.vertices() {
//}
//return mgl32.Vec3{triangle.v1, triangle.v2, triangle.v3}
//}
