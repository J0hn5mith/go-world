...
//func handleCollision(bodyA, bodyB *go_world.RigidBody, particleA, particleB *go_world.MassParticle) {
//}
func detectCollision(bodyA, bodyB *go_world.RigidBody, particleA, particleB *go_world.MassParticle) go_world.Collision {
